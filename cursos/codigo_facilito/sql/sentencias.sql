...
CREATE DATABASE IF NOT EXISTS libreria_cf character set utf8mb4;
USE libreria_cf;
...
ALTER TABLE autores ADD email VARCHAR(50) NOT NULL DEFAULT 'coso@yopmail.com';
...
ALTER TABLE libros ADD biblioteca VARCHAR(50) NOT NULL DEFAULT 'La Gran Bodega';
...
SELECT * FROM libros ORDER BY libro_id ASC limit 10;
